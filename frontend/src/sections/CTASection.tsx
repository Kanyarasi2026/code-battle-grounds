...
const CTASection = () => {
  return (
    <section style={{ padding: '120px 32px', borderTop: '1px solid rgba(255,255,255,0.04)', position: 'relative', overflow: 'hidden', textAlign: 'center', background: '#0a0a0a' }}>
      {/* Diffuse white haze — non-literal depth, not a spotlight */}
      <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: '800px', height: '560px', background: 'radial-gradient(ellipse at 50% 42%, rgba(255,255,255,0.028) 0%, rgba(255,255,255,0.010) 40%, transparent 68%)', pointerEvents: 'none' }} />
      {/* Faint edge vignette */}
      ...
      >
        <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '10px', color: 'rgba(255,255,255,0.32)', letterSpacing: '0.2em', marginBottom: '20px' }}>READY TO ENTER THE ARENA?</div>
        <h2 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: '52px', letterSpacing: '-0.03em', color: 'rgba(255,255,255,0.96)', lineHeight: 1.08, margin: '0 0 20px' }}>
          Practice smarter. Assess fairly.<br />Learn together.
        </h2>
        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '16px', color: 'rgba(255,255,255,0.44)', lineHeight: 1.75, maxWidth: '480px', margin: '0 auto 44px' }}>
