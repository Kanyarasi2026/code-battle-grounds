...
export function registerCodebattlegroundTheme(monaco: Monaco): void {
  monaco.editor.defineTheme('codebattleground', codebattlegroundTheme);
}

export default codebattlegroundTheme;
