...
const features: FeaturesByRole = {
  academic: [
    ...
    },
    {
      ...
      description: 'Review any coding session keystroke-by-keystroke',
      badge: 'Analytics',
      route: '/replay',
    },
    {
      ...
      description: 'Track student progress and identify common error patterns',
      badge: 'Faculty',
      route: '/analytics',
    },
    {
  ...
  return (
    <div className="features-selection">
      ...
      <div className="features-selection__container">
        ...
        <motion.div
          className="features-selection__footer"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.8, duration: 0.6 }}
        >
          <motion.div
            className="features-selection__starter"
            whileHover={{ scale: 1.05, x: 4 }}
          >
            <Play size={16} />
            <span>Or start with a room</span>
          </motion.div>
